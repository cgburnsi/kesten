...
| 3 | solver1d liquid-vapor region | regression | `docs/verification/LV_region_Kesten_Output.txt` | implemented | Baseline and first physics liquid-vapor slices are both wired through the same tolerance-gate runner. |
