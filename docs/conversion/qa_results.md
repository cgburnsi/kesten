...
| Introduction | `docs/conversion/sections/01-introduction.md` | pass | reviewed | Markdown keeps placeholder references; canonical LaTeX now uses BibTeX citations. |
...
|---|---|---|---|---|
| Canonical LaTeX modularization | `docs/latex/kesten_1968.tex`, `docs/latex/sections/00-front-matter.tex`, `docs/latex/sections/01-introduction.tex`, `docs/latex/sections/02-description-of-analyses.tex`, `docs/latex/sections/03-discussion-of-programs.tex`, `docs/latex/sections/04-list-of-symbols.tex`, `docs/latex/sections/05-description-of-subroutines.tex`, `docs/latex/sections/06-appendix-ii-program-listings.tex` | pass | reviewed | None blocking. Host build workflow verified. |

## 2026-02-15 Milestone-2 citation/build pass
| Scope | File(s) | Result | Status after QA | Key open items |
|---|---|---|---|---|
| Citation conversion to BibTeX | `docs/latex/sections/01-introduction.tex`, `docs/latex/sections/02-description-of-analyses.tex`, `docs/latex/sections/03-discussion-of-programs.tex`, `docs/latex/sections/04-list-of-symbols.tex`, `docs/latex/sections/05-description-of-subroutines.tex`, `docs/latex/references.bib` | pass | reviewed | Legacy references 3-11 still have incomplete publication metadata from source scans. |
| Canonical PDF build with bibliography | `docs/latex/kesten_1968.tex`, `docs/latex/BUILD.md`, `tools/build_pdf.sh` | pass | reviewed | Non-blocking warnings tracked in `docs/conversion/known-formatting-deltas.md`. |
