	...
	Progress previously reported in the first annual report (\cite{ref1_annual_report_1}) included the development of a computer program which describes the steady-state behavior of a continuous flow type reactor system in which complete radial mixing in the free-gas (or liquid) phase was assumed.
	Progress previously reported in the second annual report (\cite{ref2_annual_report_2}) included an extension of the steady-state program to include radial as well as axial variations in temperature and concentrations in order to permit an analysis of various injection schemes and catalyst bed configurations which exhibit radial nonuniformities.
